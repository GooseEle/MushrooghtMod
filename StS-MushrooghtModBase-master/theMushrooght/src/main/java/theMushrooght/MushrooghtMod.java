...
import theMushrooght.variables.DefaultCustomVariable;
import theMushrooght.variables.DefaultSecondMagicNumber;
...
@SpireInitializer
public class MushrooghtMod implements
        EditCardsSubscriber,
    ...
    public static final Logger logger = LogManager.getLogger(theMushrooght.MushrooghtMod.class.getName());
    ...
    private static final String AUTHOR = "Gremious"; // And pretty soon - You! (Me - GooseEle)
    ...
    public static final Color MUSHROOGHT_MUSH = CardHelper.getColor(70.0f, 121.0f, 102.0f);
    ...
    private static final String ATTACK_DEFAULT_GRAY = "theMushrooghtResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "theMushrooghtResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "theMushrooghtResources/images/512/bg_power_default_gray.png";

    private static final String ENERGY_ORB_DEFAULT_GRAY = "theMushrooghtResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "theMushrooghtResources/images/512/card_small_orb.png";

    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "theMushrooghtResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "theMushrooghtResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "theMushrooghtResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "theMushrooghtResources/images/1024/card_default_gray_orb.png";
    ...
    // =============== SUBSCRIBE, CREATE THE COLOR_MUSHROOM, INITIALIZE =================

    public MushrooghtMod() {
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = theMushrooght.MushrooghtMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = theMushrooght.MushrooghtMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT
        String packageName = theMushrooght.MushrooghtMod.class.getPackage().getName(); // STILL NO EDIT ZONE
    ...
    public static void initialize() {
        ...
        theMushrooght.MushrooghtMod defaultmod = new theMushrooght.MushrooghtMod();
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("theMushrooghtArtifact") // ${project.artifactId}
    ...
    public void receiveEditStrings() {
        ...
        if (!Gdx.files.internal(getModID() + "Resources/localization/" + langKey).exists()) {
            System.out.println("theMushrooght: Language not found: " + langKey);
            return;
        }

        BaseMod.loadCustomStrings(CardStrings.class, GetLocString(langKey, "CardStrings"));
        BaseMod.loadCustomStrings(CharacterStrings.class, GetLocString(langKey, "CharacterStrings"));
        BaseMod.loadCustomStrings(EventStrings.class, GetLocString(langKey, "EventStrings"));
        BaseMod.loadCustomStrings(PotionStrings.class, GetLocString(langKey, "PotionStrings"));
        BaseMod.loadCustomStrings(PowerStrings.class, GetLocString(langKey, "PowerStrings"));
        BaseMod.loadCustomStrings(RelicStrings.class, GetLocString(langKey, "RelicStrings"));
        BaseMod.loadCustomStrings(UIStrings.class, GetLocString(langKey, "UIStrings"));
    }
    ...
    public static void loadJokeCardImage(AbstractCard card, String img) {
        if (card instanceof AbstractMushrooghtCard)
            ((AbstractMushrooghtCard)card).betaArtPath = img;
        Texture cardTexture = TextureLoader.getTexture(getModID() + "Resources/images/betacards/" + img);
